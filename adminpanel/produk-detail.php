    ...
    <div class="container mt-5">
        ...
        <div class="col-12 col-md-6">
            <form action="" method="post" enctype="multipart/form-data">
                <div>
                    <label for="nama" class="mb-2 fw-bold">Nama</label>
                    <input type="text" name="nama" id="nama" class="form-control" value="<?php echo $data['nama']; ?>">
                </div>
                <div>
                    <label for="kategori" class="mb-2 fw-bold">Kategori</label>
                ...
                <div>
                    <label for="harga" class="mb-2 fw-bold">Harga</label>
                    <input type="number" class="form-control" value="<?php echo $data['harga'] ?>" name="harga">
                </div>
                <div>
                    <label for="currentFoto" class="mb-2 fw-bold">Foto Produk Sekarang</label>
                    <img src="../image/<?php echo $data['foto']; ?>" alt="" class="img-fluid">
                </div>
                <div>
                    <label for="foto" class="mb-2 fw-bold">Upload Foto Baru</label>
                    <input type="file" name="foto" id="foto" class="form-control">
                    <small>Ukuran maksimal 500 KB</small>
                </div>
                <div>
                    <label for="detail" class="mb-2 fw-bold">Detail</label>
                    <textarea name="detail" id="detail" cols="30" rows="10" class="form-control">
                        <?php echo $data['detail']; ?>
                    </textarea>
                </div>
                <div>
                    <label for="ketersediaan_stok" class="mb-2 fw-bold">Ketersediaan Stok</label>
